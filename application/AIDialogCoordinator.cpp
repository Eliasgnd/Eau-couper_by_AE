...
AIDialogCoordinator::AIDialogCoordinator(QObject *parent)
    : QObject(parent)
{
}

void AIDialogCoordinator::setDialogParent(QWidget *parent)
{
    m_dialogParent = parent;
}

bool AIDialogCoordinator::openGenerationPrompt(QWidget *parent, AiGenerationRequest &request) const
{
...
void AIDialogCoordinator::onGenerationStatus(const QString &msg)
{
    emit generationStatusChanged(msg);
}

void AIDialogCoordinator::onAiImageReady(const QString &imagePath)
{
