...
""));
        ...
        Cercle->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        Rectangle->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        Triangle->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        Coeur->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        Etoile->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        buttonInventaire->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        buttonCustom->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        buttonFileReceiver->setLayoutDirection(Qt::LeftToRight);
...
""));
        ...
        Slider_longueur->setOrientation(Qt::Horizontal);
...
""));
        ...
        Slider_largeur->setOrientation(Qt::Horizontal);
...
"}"));
        Largeur->setButtonSymbols(QAbstractSpinBox::UpDownArrows);
...
"}"));
        ...
        pushButton->setGeometry(QRect(230, 570, 151, 81));
...
""));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/on-off.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/icons/arrow-up.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icons/arrow-down.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icons/arrow-right.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/icons/arrow-left.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/icons/rotate-left.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/icons/rotate-right.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/icons/stop.svg"), QSize(), QIcon::Normal, QIcon::Off);
        Stop->setIcon(icon15);
...
""));
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/icons/pause.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/icons/play.svg"), QSize(), QIcon::Normal, QIcon::Off);
        Play->setIcon(icon17);
